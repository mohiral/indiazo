...
const CrashGame = () => {
  ...
  const startAnimation = () => {
    ...
    const animate = () => {
      ...
      const maxX = canvasWidth - 50 // Leave some margin
      ...
      if (baseX <= maxX) {
        ...
        // Logarithmic slowdown when approaching the edge
        const overflow = baseX - maxX
        x = maxX + Math.log10(1 + overflow) * 10
      }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-blue-950 flex flex-col items-center justify-center text-white p-4 relative">
      ...
      <div className="w-full max-w-3xl bg-gray-900 p-4 rounded-b-lg flex flex-col items-center relative border border-gray-700 overflow-hidden">
        ...
        {/* Game canvas */}
        <div className="relative w-full h-[400px] border-l-2 border-b-2 border-gray-700 mb-4">
          ...
          {crashed && (
            <motion.div
              ...
              style={{
                position: "absolute",
                left: lastPointRef.current.x - 50,
